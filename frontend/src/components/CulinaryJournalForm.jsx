        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-col items-center">
              <label
                htmlFor="imageInput"
                className="w-full max-w-md bg-gray-700 border border-gray-600 rounded-3xl p-4 text-center cursor-pointer hover:bg-gray-600 transition-colors flex items-center justify-center"
              >
                <svg
